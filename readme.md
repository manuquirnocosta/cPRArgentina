...
cPRA_HLA is the fraction of donors with one or more unacceptable HLA antigens.

f_ABO-incompatible is the summed phenotype frequency of donors that are ABO-incompatible with the candidate, calculated from the local donor dataset.
...
Example:
For a candidate with cPRA_HLA = 50% and f_ABO-incompatible = 0.40,
